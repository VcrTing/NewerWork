...
import { confCardTheme } from '@/__conf/__conf'
    ...
    return {
      globalConfig: {
        ...
        theme: {
          ...
          cardColor: confCardTheme.bg,
          textColor: confCardTheme.text,
          luckyCardColor: confCardTheme.bgLuky,
          patternColor: confCardTheme.bgHightLight,
          cardWidth: 140,
          cardHeight: 200,
          textSize: 30,
